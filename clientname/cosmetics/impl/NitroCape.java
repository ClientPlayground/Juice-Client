...
public class NitroCape extends CosmeticBase {
		...
		public void render(AbstractClientPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks,
	        ...
	        {
				if(CosmeticController.monkiesCape(entitylivingbaseIn) == 100) {
		...
		public static boolean ownsCosmetic() {
			if(mc.getSession().getUsername().equalsIgnoreCase("quickdaffy")) return true;
